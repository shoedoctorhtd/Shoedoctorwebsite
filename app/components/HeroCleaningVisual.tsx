...
/**
 * Keep the before-treatment shoe useful and stable on the first paint. The
 * secondary clean frame is intentionally requested after the hero copy has
 * had a chance to render, then it enables the decorative cleaning sequence.
 */
