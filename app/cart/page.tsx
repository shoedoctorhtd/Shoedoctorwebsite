...
export default async function CartPage() {
  ...
  return <ProductCartProvider><main id="main-content" className={`public-site ${styles.page}`}><SiteHeader /><section className={styles.cartPage}><p className="sd-kicker">Care essentials</p><h1>YOUR CARE CART.</h1><ProductCartPage products={products} /></section><SiteFooter /></main></ProductCartProvider>;
}
