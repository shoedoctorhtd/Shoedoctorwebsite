export const steamCleaningContent = {
  badge: "FIRST IN NEPAL",
  technologyLabel: "STEAM BRUSH TECHNOLOGY",
  marketingClaim: "Nepal’s First Steam Gun Brush Shoe Cleaning",
  image: {
    src: "/images/steam-brush-cleaning.webp",
    alt: "Shoe Doctor steam gun brush detailing a sneaker sole",
  },
} as const;
